...
<div class="constitution">
    ...
    <p>4 IR Spots (Player must be labeled as IR, Out, or Covid in the Sleeper App)</p>
        ...
        <div class="subBlock">
            <table class="positionMaximums">
                <tr><td>QB</td><td class="right">1 active, 4 total</td></tr>
                <tr><td>RB</td><td class="right">2 active, 8 total</td></tr>
                <tr><td>WR</td><td class="right">2 active, 8 total</td></tr>
                <tr><td>TE</td><td class="right">1 active, 3 total</td></tr>
                <tr><td>FLEX</td><td class="right">1 active</td></tr>
                <tr><td>D/ST</td><td class="right">1 active, 3 total</td></tr>
                <tr><td>K</td><td class="right">1 active, 3 total</td></tr>
            </table>
        </div>
    ...
    <p>Trading of players and draft picks are allowed. Trades will process after a review timeline of 2 days. Trades will be vetoed by vote of at least 4 owners. Tradable assets include players, draft picks, and FAAB $.</p>
    
    <h4 bind:this={oneTwoOne}>1.2.1 Trade Collusion</h4>
    <div class="subBlock">
        <p>If any owners are suspected of accepting bribes/offering bribes to enhance their/another owners team via trade, trading any assets other than fantasy players, draft picks, FAAB $, or otherwise found guilty of engaging in any form of collusion*, all parties involved in the trade will be susceptible to punishment by vote of the non-involved owners.</p>
    ...
    <div class="subBlock">
        <p>Any player traded from a team may not be re-acquired via trade within 6 weeks of the original trade. </p>
    </div>
    ...
    <div class="subBlock">
        <p>A total of 4 veto votes are required to veto a trade. Vetoes are only appropriate in instances of collusion or an egregious mismatch of value (i.e. CMC for a backup kicker). Not liking a trade does not warrant a veto.</p>
    </div>
    ...
    <p>FAAB Waiver wire system. Each team will begin the season with $200. Minimum bid is $1. Bids will process Wednesdays at 12 AM.</p>
    ...
    <p>Short of continuously failing to set a valid lineup, or confirmed collusion, no manager can be removed against their will. Participation, through the league chat, trade offers, and the waiver wire, is strongly encouraged but not generally grounds for removal. Removal of a non-responsive owner must be approved by vote of 75% of uninvolved owners.</p>
    ...
    <p>League dues are set at {dues}$. All managers must be fully paid up before the start of regular season. In the event that a manager fails to pay before the deadline, (I forgot what we decided the penalty is.</p>
    
    <h3 bind:this={sevenTwo}>7.2 Payout</h3>
    <p>League payout is structured as follows: (I need to ask Ryan, below are placeholders)</p>
    <ul>
